...
/**
 * @param {string} text
 * @param {Language} [lang="ko-KR"]
 * @param {boolean} [slow=false]
 * @param {string} cfg.host
 * @param {number} cfg.timeout
 * @param {string} cfg.splitPunct
 */
function getVoiceStream(text, {lang = 'ko', slow = false, host = 'https://translate.google.com', timeout = 1000, splitPunct} = {}) {
    const stream = new Stream.PassThrough();
 ...
 * @param {string} text
 * @param {PlainObject} cfg
 * @param {Language} [cfg.lang="ko-KR"]
 * @param {number} [cfg.slow=false]
 * @param {string} cfg.host
 * @param {number} cfg.timeout
 * @param {string} cfg.splitPunct
 */
function saveToFile(filePath, text, {lang = 'ko', slow = false, host, timeout, splitPunct} = {}) {
    const stream = new Stream.PassThrough();
